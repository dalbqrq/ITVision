...
function compare_app_state2(old_state, new_state)
	for i,n in ipairs(new_state) do				-- iteracts throw new application states
		for j,o  in ipairs(old_state) do		-- for each new application state, iteracts throw old states
